...
\begin{columns}
  ...
  \begin{tikzpicture}[>=stealth, node distance=1.5cm]
    ...
    \node (Hamiltonian) at (0,0) {
      \scalebox{0.8}{\textcolor{blue}{\textbf{Apa yang menyebabkan disipasi panas terjadi?}}
}
    };
\pause
...
\begin{columns}
  \column{0.5\textwidth}
  \textcolor{blue}{\textbf{Disipasi tercipta dari tumbukan elektron dengan kisi kristal.}}
  \pause
    \begin{image}
      \includegraphics[width=0.8\textwidth]{picture/road_analogy.pdf}
    \end{image}
    \pause
  \column{0.5\textwidth}
    \begin{image}
      ...
      \begin{center}
        ...
        \end{tikzpicture}
      \end{center}
      Degan ini arus akan memiliki arah yang teratur
    \end{image}
\end{columns}
\end{frame}

\begin{frame}
  \frametitle{Urgensi Quantum Spin Hall Effect}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      Bagaimana Spintronics dapat terwujud secara praktis?
      \pause
      \begin{center}
        \begin{tikzpicture}
          \draw[->, thick] (0,1) -- (0,0);
      ...
      \begin{image}
        \includegraphics[width=0.8\textwidth]{picture/hall.png}       
      \end{image}
    \end{column}
    \begin{column}{0.5\textwidth}
     \begin{image}
       \includegraphics[width=1.0\textwidth]{picture/qhall-effect.png}
...
\begin{frame}
  \frametitle{Perkembangan Penelitian}
  \begin{columns}
    \begin{column}{0.5\textwidth}
   % penelitian Kane-Mele
      Kane-Mele telah melakukan penelitian yang menunjukkan adanya efek QSHE pada grafena.
    \begin{image}
      \includegraphics[width=0.6\textwidth]{picture/haldane_hoppings.pdf}
    \end{image}
   \end{column}
   \pause 
   \begin{column}{0.5\textwidth}
     Penelitian \parencite{Lau} juga memberikan ide untuk mempelajari efek stacking layer pada grafena.
     \pause
     \textcolor{blue}{\textbf{Pertanyaan yang muncul kemudian adalah|}}
     \pause
     \begin{itemize}
       \item Karena grafena dimodifikasi sebelum menunjukkan efek QSHE, apa yang terjadi kalau kita lakukan variasi parameter?
         \pause
       \item Apakah penumpukan grafena menunjukkan efek kuantum yang berbeda dengan satu lapisan?
     \end{itemize}
   \end{column}
  \end{columns}
